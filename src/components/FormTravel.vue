<template>
    <div id="form-travels" class="flex flex-col p-6 bg-white w-2/3 shadow-xl rounded-2xl">
        ...
        <el-form :model="ruleForm" :rules="rules" :ref="nameRef">
            ...
            <div class="text-center mx-auto">
                <button type="button" @click="travel != null ? updateForm(ruleForm) : submitForm(ruleForm)"
