<template>
    <div class="w-full py-8 px-10 bg-user-form">
        <div @click="goToListUsers" class="flex items-center text-primary-100 cursor-pointer">
            <el-icon size="30"><ArrowLeftBold /></el-icon>
            <span class="text-primary-200 font-semibold text-lg ml-2">Listar usuarios</span>
        </div>
    
        <h2 class="text-3xl text-center text-primary-300 font-bold mb-8">Nuevo Usuario</h2>
